...
def create_datasets(data_path, args, candidate_path = None, mode='train', is_labeled=True, normalize_embedding = True, embed_scaler=None, is_huggingface = False):
    # Define Dataset
    ...
    if mode == 'train':
        ...
        #### FINAL TRAIN DATASET ###
        dataset = DKZ_Dataset(phospho_embedded, train_ds.KinaseEmbeddings, labels, train_ds.UniqueKinaseEmbeddings, args=args, is_train=True, is_input_tensor=is_huggingface)
        ...
        if candidate_path is not None:
            ...
            if is_labeled:
                ...
                #### FINAL VAL DATASET ###
                dataset = DKZ_Dataset(phospho_embedded, val_test_ds.KinaseEmbeddings, val_labels, val_test_ds.UniqueKinaseEmbeddings, args=args, is_train=False, is_input_tensor=is_huggingface)
