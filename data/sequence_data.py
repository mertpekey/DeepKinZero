...
class all_seq_dataset:
    ...
    ## I don't know where these variables outside of the init yet
    ...
    def get_data(self, datapath, AllKinases, is_labeled=False, MultiLabel=False):
        """
    ...
    def create_onehot_class_embeddings(self):
        """
